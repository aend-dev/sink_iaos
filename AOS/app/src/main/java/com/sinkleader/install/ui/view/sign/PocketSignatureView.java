package com.sinkleader.install.ui.view.sign;
...
//        canvasColor = Color.parseColor("#ffffff");
    ...
    private void InitializelayoutProperties() {
        signatureBoundRect = new RectF(0, 0, screenWidth, screenHeight);
//        setBackgroundColor(canvasColor);
        setBackgroundResource(R.drawable.xml_sign_background);
    }
